...
🚀 Oulik is not only **painless to setup** and **completely uncomplicated**, its unique API makes **state updates effortless** and **consistent**, while **accurately describing** them for you within the [Redux Devtools extension](https://chrome.google.com/webstore/detail/redux-devtools/lmhkpmbekcpmknklioeibfkpmmfibljd?hl=en)
