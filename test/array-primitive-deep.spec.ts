...
describe('array-primitive-deep', () => {
  ...
  it('should increment all elements', () => {
    ...
    expect(currentAction(select)).toEqual({ type: 'arr.incrementAll()', payload });
  ...
  it('should find an element and replace it', () => {
    ...
    select.arr
      .find.eq(2)
      .replace(payload);
    expect(currentAction(select)).toEqual({ type: 'arr.find.eq(2).replace()', payload });
  ...
  it('should find an element and remove it', () => {
    ...
    select.arr
      .find.eq(2)
      .remove();
    expect(currentAction(select)).toEqual({ type: 'arr.find.eq(2).remove()' });
  ...
  it('should find an element and increment it', () => {
    ...
    select.arr
      .find.eq(2)
      .increment(payload);
    expect(currentAction(select)).toEqual({ type: 'arr.find.eq(2).increment()', payload });
  ...
  it('should find an element by one clause or another and replace it', () => {
    ...
    select.arr
      .find.eq(1).or.eq(2)
      .replace(payload);
    expect(currentAction(select)).toEqual({ type: 'arr.find.eq(1).or.eq(2).replace()', payload });
  ...
  it('should find an element by one clause or another and remove it', () => {
    ...
    select.arr
      .find.eq(1).or.eq(2)
      .remove();
    expect(currentAction(select)).toEqual({ type: 'arr.find.eq(1).or.eq(2).remove()' });
  ...
  it('should find an element by one clause or another and increment it', () => {
    ...
    select.arr
      .find.eq(1).or.eq(2)
      .increment(1);
    expect(currentAction(select)).toEqual({ type: 'arr.find.eq(1).or.eq(2).increment()', payload });
  ...
  it('should find an element by one clause and another and replace it', () => {
    ...
    select.arr
      .find.gt(1).and.lt(3)
      .replace(payload);
    expect(currentAction(select)).toEqual({ type: 'arr.find.gt(1).and.lt(3).replace()', payload });
    expect(select.state).toEqual({ arr: [1, 9, 3] });
  })
  ...
  it('should find an element by one clause and another and remove it', () => {
    ...
    select.arr
      .find.gt(1).and.lt(3)
      .remove();
    expect(currentAction(select)).toEqual({ type: 'arr.find.gt(1).and.lt(3).remove()' });
    expect(select.state).toEqual({ arr: [1, 3] });
  })
  ...
  it('should find an element by one clause and another and increment it', () => {
    ...
    select.arr
      .find.eq(1).and.lt(2)
      .increment(payload);
    expect(currentAction(select)).toEqual({ type: 'arr.find.eq(1).and.lt(2).increment()', payload });
    expect(select.state).toEqual({ arr: [2, 2, 3] });
  })
  ...
  it('should filter elements and remove them', () => {
    ...
    select.arr
      .filter.gt(1)
      .remove();
    expect(currentAction(select)).toEqual({ type: 'arr.filter.gt(1).remove()' });
  ...
  it('should filter elements and increment them', () => {
    ...
    select.arr
      .filter.gt(1)
      .increment(1);
    expect(currentAction(select)).toEqual({ type: 'arr.filter.gt(1).increment()', payload });
  ...
  it('should filter elements by one clause or another and remove them', () => {
    ...
    select.arr
      .filter.eq(1).or.eq(2)
      .remove();
    expect(currentAction(select)).toEqual({ type: 'arr.filter.eq(1).or.eq(2).remove()' });
  ...
  it('should filter elements by one clause or another and increment them', () => {
    ...
    select.arr
      .filter.eq(1).or.eq(2)
      .increment(1);
    expect(currentAction(select)).toEqual({ type: 'arr.filter.eq(1).or.eq(2).increment()', payload });
  ...
  it('should filter elements by one clause and another and remove them', () => {
    ...
    select.arr
      ...
      .remove();
    expect(currentAction(select)).toEqual({ type: 'arr.filter.gt(0).and.lt(3).remove()' });
    expect(select.state).toEqual({ arr: [3] });
  })
  ...
  it('should filter elements by one clause and another and increment them', () => {
    ...
    select.arr
      ...
      .increment(1);
    expect(currentAction(select)).toEqual({ type: 'arr.filter.gt(0).and.gt(1).increment()', payload });
    expect(select.state).toEqual({ arr: [1, 3, 4] });
  })
