...
describe('array.filter().replace()', () => {
  ...
  it('should eq()', () => {
    ...
    expect(testState.currentAction).toEqual({
      type: `array.filter(id).eq(2).replaceAll()`,
      replacement: payload,
      where: [
        { 'id.eq': 2 }
      ],
  ...
  it('should ne()', () => {
    ...
    select(s => s.array)
      ...
      .replaceAll(payload);
    expect(testState.currentAction).toEqual({
      type: `array.filter(id).ne(2).replaceAll()`,
      replacement: payload,
      where: [
        { 'id.ne': 2 }
      ],
  ...
  it('should gt()', () => {
    ...
    select(s => s.array)
      ...
      .replaceAll(payload);
    expect(testState.currentAction).toEqual({
      type: `array.filter(id).gt(1).replaceAll()`,
      replacement: payload,
      where: [
        { 'id.gt': 1 }
      ],
  ...
  it('should gte()', () => {
    ...
    select(s => s.array)
      ...
      .replaceAll(payload);
    expect(testState.currentAction).toEqual({
      type: `array.filter(id).gte(1).replaceAll()`,
      replacement: payload,
      where: [
        { 'id.gte': 1 }
      ],
  ...
  it('should lt()', () => {
    ...
    select(s => s.array)
      ...
      .replaceAll(payload);
    expect(testState.currentAction).toEqual({
      type: `array.filter(id).lt(2).replaceAll()`,
      replacement: payload,
      where: [
        { 'id.lt': 2 }
      ],
  ...
  it('should lte()', () => {
    ...
    select(s => s.array)
      ...
      .replaceAll(payload);
    expect(testState.currentAction).toEqual({
      type: `array.filter(id).lte(2).replaceAll()`,
      replacement: payload,
      where: [
        { 'id.lte': 2 }
      ],
  ...
  it('should in()', () => {
    ...
    select(s => s.array)
      ...
      .replaceAll(payload);
    expect(testState.currentAction).toEqual({
      type: `array.filter(id).in(1,2).replaceAll()`,
      replacement: payload,
      where: [
        { 'id.in': [1, 2] }
      ],
  ...
  it('should ni()', () => {
    ...
    select(s => s.array)
      ...
      .replaceAll(payload);
    expect(testState.currentAction).toEqual({
      type: `array.filter(id).ni(1,2).replaceAll()`,
      replacement: payload,
      where: [
        { 'id.ni': [1, 2] }
      ],
  ...
  it('should match()', () => {
    ...
    select(s => s.array)
      ...
      .replaceAll(payload);
    expect(testState.currentAction).toEqual({
      type: `array.filter(value).match(/^t/).replaceAll()`,
      replacement: payload,
      where: [
        { 'value.match': /^t/ }
      ],
