...
describe('array-primitive', () => {
  ...
  it('should increment all elements', () => {
    ...
    expect(currentAction(store)).toEqual({ type: 'incrementAll()', payload });
  ...
  it('should find an element and increment it', () => {
    ...
    store
      .$find.$eq(2)
      .$increment(payload);
    expect(currentAction(store)).toEqual({ type: 'find.eq(2).increment()', payload });
  ...
  it('should find an element by one clause or another and increment it', () => {
    ...
    store
      .$find.$eq(1).$or.$eq(2)
      .$increment(1);
    expect(currentAction(store)).toEqual({ type: 'find.eq(1).or.eq(2).increment()', payload });
  ...
  it('should find an element by one clause and another and increment it', () => {
    ...
    store
      .$find.$eq(1).$and.$lt(2)
      .$increment(payload);
    expect(currentAction(store)).toEqual({ type: 'find.eq(1).and.lt(2).increment()', payload });
    expect(store.$state).toEqual([2, 2, 3]);
  })
  ...
  it('should filter elements and increment them', () => {
    ...
    store
      .$filter.$gt(1)
      .$increment(1);
    expect(currentAction(store)).toEqual({ type: 'filter.gt(1).increment()', payload });
  ...
  it('should filter elements by one clause or another and increment them', () => {
    ...
    store
      .$filter.$eq(1).$or.$eq(2)
      .$increment(1);
    expect(currentAction(store)).toEqual({ type: 'filter.eq(1).or.eq(2).increment()', payload });
  ...
  it('should filter elements by one clause and another and increment them', () => {
    ...
    store
      ...
      .$increment(payload);
    expect(currentAction(store)).toEqual({ type: 'filter.gt(0).and.gt(1).increment()', payload });
