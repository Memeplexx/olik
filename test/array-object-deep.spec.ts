...
test('should replace all elements properties', () => {
  ...
  store.arr.val
    .$set(payload);
  expect(currentAction(store)).toEqual({ type: 'arr.val.$set()', payload });
...
test('should find an element and replace it', () => {
  ...
  store.arr
    .$find.id.$eq(2)
    .$set(payload);
  expect(currentAction(store)).toEqual({ type: 'arr.$find.id.$eq(2).$set()', payload });
...
test('should find an element by one clause or another and replace it', () => {
  ...
  store.arr
    ...
    .$set(payload);
  expect(currentAction(store)).toEqual({ type: 'arr.$find.id.$eq(1).$or.id.$eq(2).$set()', payload });
...
test('should find an element by one clause and another and replace it', () => {
  ...
  store.arr
    ...
    .$set(payload);
  expect(currentAction(store)).toEqual({ type: 'arr.$find.id.$gt(1).$and.id.$lt(3).$set()', payload });
