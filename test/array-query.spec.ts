...
describe('array-query', () => {
  ...
  it('should find an element with one clause and another and replace it', () => {
    ...
    select.arr
      ...
      .replace(payload);
    expect(select.read()).toEqual({ ...initialState, arr: [payload, initialState.arr[1], initialState.arr[2]] })
  });
  ...
  it('should find an element with one clause and another and patch it', () => {
    ...
    select.arr
      .find.id.eq(1).and.id.lt(2)
      .patch(payload);
    expect(select.read()).toEqual({ ...initialState, arr: [{ ...initialState.arr[0], ...payload }, initialState.arr[1], initialState.arr[2]] })
  });
  ...
  it('should filter elements with one clause or another and patch them', () => {
    ...
    select.arr
      ...
      .patch(payload);
    expect(select.read()).toEqual({ ...initialState, arr: [{ ...initialState.arr[0], ...payload }, { ...initialState.arr[1], ...payload }, initialState.arr[2]] })
  });
  ...
  it('should find an element by a clause and a clause or a clause, and then replace it', () => {
    ...
    expect(select.read()).toEqual({ arr: [initialState.arr[0], initialState.arr[1], payload] });
  })
  ...
  it('should find an element by a clause and a clause or a clause and a clause, and then replace it', () => {
    ...
    expect(select.read()).toEqual({ arr: [payload, initialState.arr[1], initialState.arr[2]] });
  })
