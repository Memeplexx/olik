...
describe('array.find().deepMerge()', () => {
  ...
  it('should eq()', () => {
    ...
    const payload = { value: 'new', another: { value: 'abc' } };
    select(s => s.array)
      .find(e => e.id).eq(2)
      .deepMerge(payload);
    expect(testState.currentAction).toEqual({
      type: `array.find(id).eq(2).deepMerge()`,
      toMerge: payload,
      where: [
        { 'id.eq': 2 }
      ],
  ...
  it('should ne()', () => {
    ...
    select(s => s.array)
      ...
      .deepMerge(payload);
    expect(testState.currentAction).toEqual({
      type: `array.find(id).ne(2).deepMerge()`,
      toMerge: payload,
      where: [
        { 'id.ne': 2 }
      ],
  ...
  it('should gt()', () => {
    ...
    select(s => s.array)
      ...
      .deepMerge(payload);
    expect(testState.currentAction).toEqual({
      type: `array.find(id).gt(1).deepMerge()`,
      toMerge: payload,
      where: [
        { 'id.gt': 1 }
      ],
  ...
  it('should gte()', () => {
    ...
    select(s => s.array)
      ...
      .deepMerge(payload);
    expect(testState.currentAction).toEqual({
      type: `array.find(id).gte(1).deepMerge()`,
      toMerge: payload,
      where: [
        { 'id.gte': 1 }
      ],
  ...
  it('should lt()', () => {
    ...
    select(s => s.array)
      ...
      .deepMerge(payload);
    expect(testState.currentAction).toEqual({
      type: `array.find(id).lt(2).deepMerge()`,
      toMerge: payload,
      where: [
        { 'id.lt': 2 }
      ],
  ...
  it('should lte()', () => {
    ...
    select(s => s.array)
      ...
      .deepMerge(payload);
    expect(testState.currentAction).toEqual({
      type: `array.find(id).lte(2).deepMerge()`,
      toMerge: payload,
      where: [
        { 'id.lte': 2 }
      ],
  ...
  it('should in()', () => {
    ...
    select(s => s.array)
      ...
      .deepMerge(payload);
    expect(testState.currentAction).toEqual({
      type: `array.find(id).in(1,2).deepMerge()`,
      toMerge: payload,
      where: [
        { 'id.in': [1, 2] }
      ],
  ...
  it('should ni()', () => {
    ...
    select(s => s.array)
      ...
      .deepMerge(payload);
    expect(testState.currentAction).toEqual({
      type: `array.find(id).ni(1,2).deepMerge()`,
      toMerge: payload,
      where: [
        { 'id.ni': [1, 2] }
      ],
  ...
  it('should match()', () => {
    ...
    select(s => s.array)
      ...
      .deepMerge(payload);
    expect(testState.currentAction).toEqual({
      type: `array.find(value).match(/^t/).deepMerge()`,
      toMerge: payload,
      where: [
        { 'value.match': /^t/ }
      ],
