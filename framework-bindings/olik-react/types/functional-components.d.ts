 ...
 */
export declare const useNestedStore: <C>(initialState: C, options: OptionsForMakingANestedStore, deps?: React.DependencyList) => Pick<{
    /**
     ...
     */
    useSelector: <R>(selector: Function<C, R>, deps?: React.DependencyList) => R;
    /**
    ...
    useDerivation: <X extends [Function<C, any>] | Function<C, any>[]>(inputs: X, deps?: React.DependencyList | undefined) => {
        usingExpensiveCalc: <R_1>(calculation: (inputs: MappedSelectorsToResults<C, X>) => R_1) => R_1;
    };
    /**
...
}, "select" | "useSelector" | "useDerivation">;
...
export declare const set: <S>(initialState: S, options?: OptionsForMakingAStore | undefined) => {
    /**
     * A hook to select a specific part of the state tree
     * @param selector a selection from the store
     * @param deps an optional array of values upon which the calculation depends
     ...
     * const todo = useSelector(s => s.some.todos.find(t => t.id === id), [id]);
     */
    useSelector: <R>(selector: Function<S, R>, deps?: React.DependencyList) => R;
    /**
     * A hook to derive state and memoise the result of a complex calculation
     * @param inputs an array of functions which select from the store
     * @param deps an optional array of values upon which the calculation depends
    ...
    useDerivation: <X extends [Function<S, any>] | Function<S, any>[]>(inputs: X, deps?: React.DependencyList | undefined) => {
        usingExpensiveCalc: <R_1>(calculation: (inputs: MappedSelectorsToResults<S, X>) => R_1) => R_1;
    };
    /**
     * Similar, in principal to React-Redux's `mapStateToProps()`
     * @param store The store that was previously defined using `make()` or `makeEnforceTags()`
...
export declare const setEnforceTags: <S>(initialState: S, options?: OptionsForMakingAStore | undefined) => {
    /**
     * A hook to select a specific part of the state tree
     * @param selector a selection from the store
     * @param deps an optional array of values upon which the calculation depends
     ...
     */
    select: import("olik").SelectorFromAStoreEnforcingTags<S>;
};
export {};
